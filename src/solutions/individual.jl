...
julia> Metaheuristics.create_child([0.1, 0.2, 0.3], 1.0)
(f = 1.0000e+00, x = [0.1, 0.2, 0.3])

julia> Metaheuristics.create_child([0.1, 0.2, 0.3], (1.0, [2.0, 0.2], [3.0, 0.3]))
(f = 1.0000e+00, g = [2.0, 0.2], h = [3.0, 0.3], x = [0.1, 0.2, 0.3])

julia> Metaheuristics.create_child([0.1, 0.2, 0.3], ([-1.0, -2.0], [2.0, 0.2], [3.0, 0.3]))
(f = [-1.0, -2.0], g = [2.0, 0.2], h = [3.0, 0.3], x = [0.1, 0.2, 0.3])
```
"""
